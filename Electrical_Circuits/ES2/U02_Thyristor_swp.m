...
hold on
xlabel('Ud'), ylabel('S1')
plot(Ud_3, S1, 'LineWidth', 2, 'DisplayName', 'Steuerkennlinie S1', 'Color', [0.8 0 0])
...
grid on, grid minor
hold on
xlabel('Ueff'), ylabel('S2')
plot(Ueff_3, S2, 'LineWidth', 2, 'DisplayName', 'Steuerkennlinie S1', 'Color', [0 0.8 0])
...
grid on, grid minor
hold on
xlabel('Ueff'), ylabel('Ud'), zlabel('Ff')
plot3(Ueff_3, Ud_3, Ff, 'LineWidth', 2, 'DisplayName', 'Formfaktor Ff', 'Color', [0.4 0.3 0.6])

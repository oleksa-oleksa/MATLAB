...
hold on
plot(0, 0, w, V1, 'LineWidth', 2, 'DisplayName','Amplitudenverst?rkung')
...
ax.YAxisLocation = 'origin';
hold on
plot(0, 0, w, phi1, 'LineWidth', 2, 'DisplayName','Phasenverschiebung')
...
ax.YAxisLocation = 'origin';
hold on
plot(0, 0, w, V2, 'LineWidth', 2, 'DisplayName','Amplitudenverst?rkung', 'Color', [0 0.8 0.7])
...
ax.YAxisLocation = 'origin';
hold on
plot(0, 0, w, phi2, 'LineWidth', 2, 'DisplayName','Phasenverschiebung', 'Color', [0 0.8 0.7])

...
U1N = 18.4*exp(j*(-30*pi/180));               % gemessen
U2N = 21.2*exp(j*(-154.5*pi/180));               %
U3N = 26.4*exp(j*(94.5*pi/180));
...
I_1 = 259e-3*exp(j*(angle(U1N/Z1N))) ;
I_1b = abs (I_1)
I_2 = 239e-3*exp(j*(angle(U2N/Z2N))) ;
I_2b = abs (I_2)
I_3 = 196e-3*exp(j*(angle(U3N/Z3N))) ;
I_3b = abs (I_3)

% quiver U12, U23, U31
figure('Name', 'Schaltung 6'), title ('Schaltung 6')

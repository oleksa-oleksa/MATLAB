classdef SimIamApp < handle
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            SimIamApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'launch')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong launch
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'launch').getString, ...
